...
namespace CorpManagement
{
    abstract class DBConnect
    {
        ...
        protected const string defaultLanguage = "en-EN";
        ...
        protected void Initialize()
        {
            ...
            if (!string.IsNullOrEmpty(server) && !string.IsNullOrEmpty(database))
            {
                if (!string.IsNullOrEmpty(domain) && !string.IsNullOrEmpty(uid) && !string.IsNullOrEmpty(password))
                    ConnectionString = @"Data Source=" + server + ";Initial Catalog=" + database + ";Integrated Security=False" + ";User ID = " + domain + @"\" + uid + "; Password = " + password + "; MultipleActiveResultSets = True;";
                else if (!string.IsNullOrEmpty(uid) && !string.IsNullOrEmpty(password))
                    ConnectionString = @"Data Source=" + server + ";Initial Catalog=" + database + ";Integrated Security=False" + ";User ID = " + uid + "; Password = " + password + "; MultipleActiveResultSets = True;";
                else
